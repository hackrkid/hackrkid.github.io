...
<xsl:template match="/atom:feed">
	...
	<meta name="description" content="HackrKid&#39;s journey, learning to program computers, take good pictures, and play the guitar">
	...
	<meta property="og:description" content="HackrKid&#39;s journey, learning to program computers, take good pictures, and play the guitar">
	<meta property="og:url" content="http://localhost:4000//assets/xslt/atom.xslt">
	<meta property="og:locale" content="en_EN">
	<meta property="og:type" content="website">
	<meta property="og:site_name" content="HackrKid">
...
<div id="navigation" class="sticky">
  <nav class="top-bar" role="navigation" data-topbar>
    <ul class="title-area">
      <li class="name">
      <h1 class="show-for-small-only"><a href="http://localhost:4000/" class="icon-tree"> HackrKid</a></h1>
    </li>
...
<div id="masthead-no-image-header">
	<div class="row">
		<div class="small-12 columns">
			<a id="logo" href="http://localhost:4000/" title="HackrKid – HackrKid's journey">
				<img src="http://localhost:4000//assets/img/logo.png" alt="HackrKid – HackrKid's journey">
			</a>
        ...
        <div class="row">
          <div class="medium-6 large-5 columns">
            ...
            <p class="shadow-black">
              HackrKid's journey, learning to program computers, take good pictures, and play the guitar
      ...
      <div id="subfooter">
        <nav class="row">
          <section id="subfooter-left" class="small-12 medium-6 columns credits">
            <p>Created with &hearts; by <a href="https://github.com/hackrkid/">HackrKid</a> with <a href="http://jekyllrb.com/" target="_blank">Jekyll</a> based on <a href="http://phlow.github.io/feeling-responsive/">Feeling Responsive</a>.</p>
          </section>

          <section id="subfooter-right" class="small-12 medium-6 columns">
            <ul class="inline-list social-icons">
            
              <li><a href="http://github.com/hackrkid" target="_blank" class="icon-github" title="Code und mehr..."></a></li>
